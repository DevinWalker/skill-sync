...
mod tests {
    ...
    fn remove_with_move_to_dir(skill: &str, target: &str, home: &std::path::Path)
    ...
    fn archives_directory_then_removes_it() {
        ...
        let res = remove_with_move_to_dir("demo", "claude", tmp.path()).expect("ok");
    ...
    fn refuses_symlink() {
        ...
        let err = remove_with_move_to_dir("linked", "claude", tmp.path()).unwrap_err();
    ...
    fn missing_path_errors() {
        ...
        let err = remove_with_move_to_dir("nope", "claude", tmp.path()).unwrap_err();
    ...
    fn cowork_rejected() {
        let tmp = tempfile::tempdir().unwrap();
        let err = remove_with_move_to_dir("x", "cowork", tmp.path()).unwrap_err();
