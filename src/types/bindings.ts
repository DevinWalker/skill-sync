...
export type Settings = { version: number, source_root: string, package_output_dir: string, show_builtins: boolean, external_bundle_roots: Array<string>, enabled_targets: Array<string>, cowork_package_enabled: boolean, theme: string, first_run_completed: boolean, };
